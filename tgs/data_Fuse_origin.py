...
class CustomGaussianFuseDataset(Dataset):
    def __init__(self, istest:bool, cfg: Any) -> None:
        ...
        self.scene_paths = os.listdir(self.cfg.source_path)
        ...
        for i, scene_path in enumerate(self.scene_paths):
            ...
            for j, part_path in enumerate(scnens_parts_paths):
                ...
                train_cameras_list = []
                cond_cameras_list = []
                with open(os.path.join(part_path, "cameras_transformed.json"), 'r') as file:
                    data = json.load(file)
                ...
                train_cameras = cameraList_from_camInfos(train_cameras_list, 1.0, self.cfg)
                ...
                gaussian_ply = load_gaussian_ply(os.path.join(part_path, "point_cloud", "transformed", "point_cloud.ply"))
